# Generated by Django 5.0.4 on 2024-04-16 03:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('men', 'MEN'), ('women', 'Women'), ('others', 'Others')], max_length=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reporting_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reported_made', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('starting_point', models.TextField(max_length=255)),
                ('end_point', models.TextField(max_length=255)),
        ...
        migrations.CreateModel(
            name='Group',
            fields=[
                ('post', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='App.post')),
                ('created_date', models.DateTimeField(auto_now_add=True)),
